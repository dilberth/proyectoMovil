...
public class ValidacionTicketTercerosCelular implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                Ensure.that(TICKET("Celular")).isDisplayed(),
                Scroll.hastaElElemento(TICKET("Correo electrónico")).elementoVisibleEnElMedioDeLaPantalla(),
                ...
                Scroll.hastaElElemento(TICKET("Impuesto de Operaciones Financieras")).elementoVisibleEnElMedioDeLaPantalla(),
    ...
    public static ValidacionTicketTercerosCelular elementos() {
        return Instrumented.instanceOf(ValidacionTicketTercerosCelular.class).withProperties();
    }
}