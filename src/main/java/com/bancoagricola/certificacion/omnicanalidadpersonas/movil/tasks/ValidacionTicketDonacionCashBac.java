...
public class ValidacionTicketDonacionCashBac implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                ...
                VerEnPantalla.elTexto(TXTINSTITUCION),
    ...
    public static ValidacionTicketDonacionCashBac elementos() {
        return Instrumented.instanceOf(ValidacionTicketDonacionCashBac.class).withProperties();
    }
}