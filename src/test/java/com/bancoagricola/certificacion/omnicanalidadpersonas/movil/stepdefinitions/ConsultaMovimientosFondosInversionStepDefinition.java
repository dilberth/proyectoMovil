...
public class ConsultaMovimientosFondosInversionStepDefinition {

    @Entonces("^consulta los movimientos del fondo de inversion por fecha$")
    public void consultaLosMovimientosDelFondoDeInversionPorFecha(List<Cuentas> datos) {
        Cuentas infoCuenta = datos.get(0);

        theActorInTheSpotlight().attemptsTo(
                IrAProducto2.cuenta(infoCuenta.getReferencia()).ySeleccionarLaTransaccion(TransaccionesCuentas.MOVIMIENTOS.tomarTransaccion()),
